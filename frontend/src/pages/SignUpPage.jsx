...
const  SignUpPage = ()=>{
  ...
  const handleSubmit = (e)=>{
    ...
    // Simulation d'une requête API (à remplacer plus tard par votre appel backend)
        ...
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">            
            ...
            <button type="submit"
                    ...
                    focus:ring-offset-2 focus:ring-emeral-500 transition duration-150 ease-in-out disabled:opacity-50"
                    disabled={loading}
                    >
              {loading?(
                   <>
                     <Loader className="mr-5 h-5 w-5 animate-spin" aria-hidden="true"/>
           ...
           <p className="mt-8 text-center text-sm text-gray-400">
             ...
             <Link to={"/login"} className="font-medium text-emerald-400 hover:text-emerald-300">
                  connectez vous <ArrowRight className="inline h-4 w-4"/>
             </Link>
           </p>
        </div>
